...
Portable working-discipline skills for claude.ai chat — prose-first, zero CLI in anything that
...
- **Prose-first skills.** The cross-surface law ("Custom Skills do not sync across surfaces")
  ...
  and the validator mechanically asserts ZERO CLI-invoking content in every shipped skill body.
